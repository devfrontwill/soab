...
export default function EditHaircut({ subscription, haircut }: EditHaircutProps) {
    ...
    return (
        <>
            <Head>
                <title> Editando modelo de corte - S.O.A.B </title>
            </Head>
            <Sidebar>
                <Flex direction="column" alignItems="flex-start" justifyContent="flex-start">
                    ...
                    <Flex maxW="700px" pt={8} mt={4} pb={8} w="100%" bg="barber.400" direction="column" align="center" justify="center">
                        ...
                        <Flex w="85%" direction="column">
                            ...
                            <Input
                                placeholder="Preço do corte ex. 39.90"
                                bg="gray.900"
                                mb={3}
                                size="lg"
                                type="number"
